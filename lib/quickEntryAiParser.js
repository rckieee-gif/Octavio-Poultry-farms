...
function buildSystemPrompt({ today, building, paidBy }) {
  ...
  return [
    ...
    "- Any gasoline, diesel, fuel, or gas purchased for the 'powersprayer' or 'sprayer' is used for farm maintenance/disinfection. You MUST categorize it as fundingNature: 'OPEX', category: 'Minor Repair', quickCategory: 'Repairs and Maintenance'.",
    "- Do NOT categorize fuel/gas/diesel for the powersprayer/sprayer as OPEX / Transport. OPEX / Transport is strictly for transportation, biyahe, fare, or transport vehicle fuel.",
    "- If the input contains both a fuel keyword (diesel, gas, gasoline, fuel) and a sprayer keyword (powersprayer, sprayer), Repairs and Maintenance / Minor Repair ALWAYS takes precedence.",
    "",
    ...
    "- Delivery / Fuel / Tubil / Gas / Gasolina / Plete / Hatod / Transpo -> OPEX / Transport (unless for powersprayer/sprayer)",
    "- Gas / Diesel / Fuel for powersprayer/sprayer -> OPEX / Minor Repair",
